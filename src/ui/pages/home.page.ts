...
export class HomePage extends SalesPortalPage {
  ...
  readonly 'Total Orders Metric container' = this.findElement(
    '#total-orders-container'
  );
  readonly 'Total Orders Metric value' =
    this['Total Orders Metric container'].locator('p');
  readonly 'Total Revenue Metric container' = this.findElement(
    '#total-revenue-container'
  );
  readonly 'Total Revenue Metric value' =
    this['Total Revenue Metric container'].locator('p');
  readonly 'New Customers Metric container' = this.findElement(
    '#total-customers-container'
  );
  readonly 'New Customers Metric value' =
    this['New Customers Metric container'].locator('p');
  readonly 'Avg Order Value Metric container' = this.findElement(
    '#avg-orders-value-container'
  );
  readonly 'Avg Order Value Metric value' =
    this['Avg Order Value Metric container'].locator('p');
  readonly 'Canceled Orders Metric container' = this.findElement(
