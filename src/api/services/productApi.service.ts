...
import { validateResponse, validateJsonSchema } from "./validation/apiValidation";
...
export class ProductsApiService {
  ...
  async create(customData?: Partial<IProduct>) {
    ...
    const response = await this.productsController.create(generateProductData(customData), token);
